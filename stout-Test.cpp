...
TEST_CASE("intersection() testing") {
	...
	// simple lines
	Edge y_eq_z{ Point{ 0,1,0 }, Point{ 0,0,1 }, Rgb{0,0,0} };
	Edge x_eq_y{ Point{ 1,0,0 }, Point{ 0,1,0 }, Rgb{0,0,0} };
	Edge x_eq_z{ Point{ 1,0,0 }, Point{ 0,0,1 }, Rgb{0,0,0} };
	Edge x_eq_y_eq_z{ Point{ 0,0,0 }, Point{ 1,1,1 }, Rgb{0,0,0} };
